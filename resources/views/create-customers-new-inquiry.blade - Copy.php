                                    ...
                                    <form action="{{ url('add-customers-new-inquiry') }}" method="POST"
                                        ...
                                        <div class="row collapse inq-div" id="afsInquiry">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <label for="afs_inquiry_type" class="form-label">Inquiry Type
                                                    </label>
                                                    <select class="form-control shadow-sm  bg-white"
                                                        name="afs_inquiry_type" id="afs_inquiry_type">
                                        ...
                                        <div class="row collapse inq-div" id="unsuccessful-calls-Inquiry">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <label for="unsuccess_calls_inquirytype" class="form-label">Inquiry
                                                        Type
                                                    </label>
                                                    <select class="form-control shadow-sm  bg-white"
                                                        name="unsuccess_calls_inquirytype"
                                                        id="unsuccess_calls_inquirytype">
                                                ...
                                                <div class="col-3">
                                                    <label for="unsuccess_calls_vehcile" class="form-label">Vehcile
                                                    </label>
                                                    <input type="text" class="form-control shadow-sm bg-whiterounded"
                                                        name="unsuccess_calls_vehcile" id="unsuccess_calls_vehcile"
                                                        placeholder="Vehcile">
                                                </div>
                                                <div class="col-3">
                                                    <label for="unsuccess_calls_vehcile_colour"
                                                        class="form-label">Colour
                                                    </label>
                                                    <input type="text" class="form-control shadow-sm bg-whiterounded"
                                                        name="unsuccess_calls_vehcile_colour"
                                                        id="unsuccess_calls_vehcile_colour" placeholder="Colour">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3 callback-value-Yes">
                                                    <label for="unsuccess_calls_follow_up" class="form-label">Follow
                                                        Up Preferred Date
                                                    </label>
                                                    <input type="date"
                                                        class="form-control shadow-sm bg-white rounded"
                                                        name="unsuccess_calls_follow_up" id="unsuccess_calls_follow_up">
                                                </div>
                                                <div class="col-3 callback-value-Yes">
                                                    <label for="unsuccess_calls_followup_prefered_time"
                                                        class="form-label">Follow Up Preferred Time </label>
                                                    <input type="time"
                                                        class="form-control shadow-sm bg-white rounded"
                                                        name="unsuccess_calls_followup_prefered_time"
                                                        id="unsuccess_calls_followup_prefered_time">
                                                </div>
                                                <div class="col-3">
                                                    <label for="unsuccess_calls_inquiry_action"
                                                        class="form-label">Actions
                                                    </label>
                                                    <select class="form-control bg-white"
                                                        name="unsuccess_calls_inquiry_action"
                                                        id="unsuccess_calls_inquiry_action">
                                                        <option value="FCR">FCR (First Call Resolution)</option>
                                                        <option value="Follow Up">Follow Up</option>
                                                        <option value="Action Required">Action Required</option>
                                                    </select>
