            ...
            <table class="example table table-striped table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> 12/2/2023 </td>
                        <td> csi </td>
                        <td class="view" data-toggle="modal" data-target=".bd-example-modal-xl" title="View Vehicle Details"> Done </td>
                        <td> 12/2/2023 </td>
                        <td>
                            <select style="border: none; background-color: transparent; font-size: 12px;" name="" id="">
                        ...
                        <td style="font-size: 20px; text-align: center;"> <i class="fa-solid fa-record-vinyl" style="cursor: pointer;"></i> </td>
                    </tr>
                    <tr>
                        <td> 2 </td>
                        <td> taha </td>
                        ...
                        <td> 12/5/2023 </td>
                        <td> warranty </td>
                        <td class="view" data-toggle="modal" data-target=".bd-example-modal-xl" title="View Vehicle Details"> Not Done </td>
                        <td> 12/5/2023 </td>
                        <td>
                            <select style="border: none; background-color: transparent; font-size: 12px;" name="" id="">
                                <option selected disabled>Select Option</option>
