    ...
    @section('content')
        <style>
            ...
            .card {
                --bs-card-border-width: 10px !important;
            }
                                    ...
                                    <div class="card-body embed-responsive" style="overflow: auto">
                                        ...
                                        <form action="{{ url('add-customers-new-inquiry') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <label class="form-label">Select City <i
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 float-right">
                                                    ...
                                                    <button type="button" style="float: right;"
                                                        class="btn btn-round btn-primary mr-2 inquiryBtn" id="afsinquiryBtn" data-type="AFS" onclick="getinquirytypes(this);" data-toggle="collapse" data-target="#afsInquiry"><i
                                            ...
                                            <div class="row collapse inq-div" id="presaleInquiry">
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="inquiry_category_presales"
                                                            id="inquiry_category_presales" value="Pre-Sales" readonly>
                                                    </div>
                                                </div>
                                                {{-- row END --}}
                                                {{-- row START --}}
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <label for="presales_inquiry_source"
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control shadow-sm bg-white"
                                                            ...
                                                            @foreach ($presale_inquiry_types as $presales_inquiry_type)
                                                                <option
                                                                    value="{{ $presales_inquiry_type->inquiry_type }}">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white inquiry_dealerships"
                                                            ...
                                                            name="presales_inquiry_dealership"
                                                            onchange="Getalldealership()">
                                                            <option value="NULL">Select Dealership</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-3">
                                                        <label for="presales_interested_vehicle"
                                                            class="form-label">Interested
                                                            Vehicle</label>
                                                    ...
                                                    <div class="col-3">
                                                        <label for="presales_interested_color"
                                                            class="form-label">Interested
                                                            Colour
                                                        </label>
                                                        <select class="form-control bg-white"
                                                            id="presales_interested_color"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <label for="presales_inquiry_details"
                                                            class="form-label">VOC&nbsp;<i
                                                                class='text-danger'>*</i></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 callback-value-Yes">
                                                        <label for="presales_followup_remarks"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <label for="sales_inquirytype" class="form-label">Inquiry
                                                            Type</label>
                                                        <select class="form-control shadow-sm bg-white"
                                                            name="sales_inquiry_type" id="sales_inquirytype">
                                                    ...
                                                    <div class="col-3" id="sales-inquiry-subtype"
                                                        style="display: none;">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <input type="text"
                                                            class="form-control shadow-sm bg-whiterounded"
                                                            name="sales_chassis" id="sales_chassis"
                                                            placeholder="Chassis">
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <input type="text"
                                                            class="form-control shadow-sm bg-white rounded"
                                                            id="sales_vehicle" name="sales_vehicle"
                                                            placeholder="Vehicle">
                                                    </div>
                                                    <div class="col-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="general_inquiry_dealership" class="form-label">
                                                            Dealership</label>
                                                        <select class="form-control bg-white inquiry_dealerships"
                                                            id="general_inquiry_dealership"
                                                            name="general_inquiry_dealership"
                                                            onchange="Getalldealership()">
                                                            <option value="NULL">Select Dealership</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row collapse inq-div" id="afsInquiry">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <input type="text"
                                                            class="form-control shadow-sm bg-white rounded" name="afs_pbo"
                                                            id="afs_pbo" placeholder="PBO">
                                                    </div>
                                                    <div class="col-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 callback-value-Yes">
                                                        ...
                                                        <input type="time"
                                                            class="form-control shadow-sm bg-white rounded"
                                                            name="afs_followup_prefered_time"
                                                            id="afs_followup_prefered_time">
                                                    </div>
                                                    <div class="col-3">
                                            ...
                                            <div class="row collapse inq-div" id="dealersip-network-Inquiry">
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="inquiry_category_dealernetwork"
                                                            class="form-label">Inquiry
                                                            Category</label>
                                                        <input type="text" inputmode="url"
                                                            class="form-control shadow-sm p-3 mb-3 text-center"
                                                            name="inquiry_category_dealernetwork"
                                                            id="inquiry_category_dealernetwork" value="Dealersip Network"
                                                            readonly>
                                                    </div>
                                                </div>
                                                {{-- row END --}}
                                                ...
                                                <div class="row">
                                                    ...
                                                    {{-- dealernetwork_inquiry_types --}}
                                                    <div class="col-3">
                                                        <label for="dealernetwork_inquiry_type"
                                                            class="form-label ">Inquiry
                                                            Type <i class='text-danger'>*</i></label>
                                                        <select class="form-control shadow-sm bg-white"
                                                            name="dealernetwork_inquiry_type"
                                                            id="dealernetwork_inquiry_type">
                                                            @foreach ($dealernetwork_inquiry_types as $dealernetwork_inquiry_type)
                                                                <option
                                                                    value="{{ $dealernetwork_inquiry_type->inquiry_type }}">
                                                                    {{ $dealernetwork_inquiry_type->inquiry_type }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white" name="dealernetwork_vehicle"
                                                            ...
                                                            @foreach ($vehicles as $dealernetwork_vehicle)
                                                                <option
                                                                    value="{{ $dealernetwork_vehicle->vehicle_name }}">
                                                    ...
                                                    <div class="col-3">
                                                        <label for="dealernetwork_vehicle_colour"
                                                ...
                                                <div class="row">
                                                    <?php if(session()->get('isLogin')[0]['role'] == 1){ ?>
                                                    <div class="col-3">
                                                        <label for="dealernetwork_assigned_agent"
                                            ...
                                            <div class="row collapse inq-div" id="feedbackInquiry">
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        ...
                                                        <input type="text"
                                                            class="form-control shadow-sm p-3 mb-3 text-center"
                                                            name="inquiry_category_feedback"
                                                            id="inquiry_category_feedback" value="Feedback" readonly>
                                                    </div>
                                                </div>
                                                {{-- row END --}}
                                                {{-- row START --}}
                                                <div class="row">
                                                    ...
                                                    <div class="col-3" id="feedback-inquiry-subtype"
                                                        style="display: none;">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white"
                                                            id="feedback_vehicle_colour" name="feedback_vehicle_colour">
                                                            <option value="NULL">Select Colour</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white"
                                                            name="feedback_inquiry_action" id="feedback_inquiry_action">
                                                            <option value="FCR">FCR (First Call Resolution)</option>
                                                            <option value="Follow Up">Follow Up</option>
                                                            <option value="Action Required">Action Required</option>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 callback-value-Yes">
                                                        <label for="feedback_followup_remarks"
                                                            class="form-label">Follow-Up
                                                            Remarks
                                                        </label>
                                            ...
                                            <div class="row collapse inq-div" id="unsuccessful-calls-Inquiry">
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="inquiry_category_unsuccess_calls"
                                                            value="Unsuccessful Calls" readonly>
                                                    </div>
                                                </div>
                                                {{-- row END --}}
                                                {{-- row START --}}
                                                <div class="row">
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control shadow-sm  bg-white"
                                                            ...
                                                            @foreach ($channel as $unsuccessful_calls_channel)
                                                                <option
                                                                    value="{{ $unsuccessful_calls_channel->source }}">
                                                    ...
                                                    <div class="col-3">
                                                        <label for="unsuccess_calls_inquiry_type"
                                                            class="form-label">Inquiry
                                                            Type
                                                        </label>
                                                        <select class="form-control shadow-sm  bg-white"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control bg-white inquiry_dealerships"
                                                            ...
                                                            name="unsuccess_calls_dealership"
                                                            onchange="Getalldealership()">
                                                            <option value="NULL">Select Dealership</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white"
                                                            ...
                                                            @foreach ($colors as $unsuccess_calls_vehicle_colour)
                                                                <option
                                                                    value="{{ $unsuccess_calls_vehicle_colour->color }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-3 callback-value-No">
                                                        <label for="unsuccess_calls_callback"
                                                            class="form-label">Callback</label>
                                                        <select class="form-control shadow-sm bg-white callback"
                                                            name="unsuccess_calls_callback"
                                                            id="unsuccess_calls_callback">
                                                            <option value="No">No</option>
                                                            <option value="Yes">Yes</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-3 callback-value-Yes">
                                                        <label for="unsuccess_calls_followup_date"
                                                            class="form-label">Follow
                                                            Up Preferred Date
                                                        </label>
                                                        <input type="date"
                                                    ...
                                                    <div class="col-3 callback-value-Yes">
                                                        <label for="unsuccess_calls_followup_time"
                                                            class="form-label">Follow
                                                            Up Preferred Time </label>
                                                        <input type="time"
                                                            class="form-control shadow-sm bg-white rounded"
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control bg-white"
                                                            name="unsuccess_calls_action" id="unsuccess_calls_action">
                                                            <option value="FCR">FCR (First Call Resolution)</option>
                                                            <option value="Follow Up">Follow Up</option>
                                                            <option value="Action Required">Action Required</option>
                                                        </select>
        ...
        <script>
            // Add event listener to the sales inquiry type select element
            salesInquiryTypeSelect.addEventListener('change', function() {
                // Get the selected value
                const selectedValue = salesInquiryTypeSelect.value;

                // Clear the options in the sales inquiry sub-type select element
                salesInquirySubTypeSelect.innerHTML = '';

                // Check if the selected value matches the conditions to show the sales inquiry sub-type div
                if (selectedValue === 'Refund' || selectedValue === 'Booking Amendments') {
                    // Add the options based on the selected value
                    if (selectedValue === 'Refund') {
                        addOption(salesInquirySubTypeSelect, 'GST Refund', 'GST Refund');
                        addOption(salesInquirySubTypeSelect, 'Excess Amount Refund', 'Excess Amount Refund');
                        addOption(salesInquirySubTypeSelect, 'FED Refund', 'FED Refund');
                    } else if (selectedValue === 'Booking Amendments') {
                        addOption(salesInquirySubTypeSelect, 'Colour Change Request', 'Colour Change Request');
                        addOption(salesInquirySubTypeSelect, 'Variant Change Request', 'Variant Change Request');
                        addOption(salesInquirySubTypeSelect, 'Delivery Premises Change Request',
                            'Delivery Premises Change Request');
                        addOption(salesInquirySubTypeSelect, 'Change of Delivery personnel',
                            'Change of Delivery personnel');
                    }

                    // Show the sales inquiry sub-type div
                    salesInquirySubTypeDiv.style.display = 'block';
                } else {
                    // Hide the sales inquiry sub-type div
                    salesInquirySubTypeDiv.style.display = 'none';
                }
            });
        ...
        <script>
            // Get references to the dropdowns
            const salesInquiryTypeDropdown = document.getElementById('sales_inquirytype');
            const salesInquirySubTypeDiv = document.getElementById('sales-inquiry-subtype');
            const salesInquirySubTypeDropdown = document.getElementById('sales_inquiry_subtype');

            // Add event listener to the salesInquiryTypeDropdown
            salesInquiryTypeDropdown.addEventListener('change', function() {
                // Hide the salesInquirySubTypeDiv by default
                salesInquirySubTypeDiv.style.display = 'none';

                // Get the selected value
                const selectedValue = salesInquiryTypeDropdown.value;
                ...
                const optionsByInquiryType = {
                    ...
                    // Add other inquiry types and their corresponding options here
                };

                // Clear previous options
                salesInquirySubTypeDropdown.innerHTML = '';

                // Check if the selectedValue is in optionsByInquiryType
                if (selectedValue in optionsByInquiryType) {
                    // Populate the salesInquirySubTypeDropdown with options based on the selected value
                    optionsByInquiryType[selectedValue].forEach(function(option) {
                        const optionElement = document.createElement('option');
                        optionElement.value = option.value;
                        optionElement.text = option.text;
                        salesInquirySubTypeDropdown.appendChild(optionElement);
                    });

                    // Show the salesInquirySubTypeDiv
                    salesInquirySubTypeDiv.style.display = 'block';
                } else {
                    // If selected value doesn't have corresponding options, hide the salesInquirySubTypeDiv
                    salesInquirySubTypeDiv.style.display = 'none';
                }
            });
        </script>
