...
<head>
    ...
    <!--Voice Calling Dailer Css........-->
    
    <link rel="stylesheet" href="{{ asset('assets/css/index.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/wphone_1.0.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/jquery.mobile.icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/jquery.mobile.structure-1.4.2.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/mainlayout.css') }}">
    
    <!--------------End.................-->

    <script>window.pageissdk = false;</script>
    <script src="{{ asset('assets/js/webphone_api.js?jscodeversion=377')}}"></script>
...
<!--            <li id="ch_item_0" data-theme="b"><a class="ch_anchor">
    ...
    <div data-role="footer" data-tap-toggle="false" id="dialpad_footer">
        <div class="ui-grid-b" id="dialpad_call_grid">
            ...
            <div class="ui-block-b" id="btn_call"><button class="ui-btn noshadow ui-btn-c">
                <img src="images/btn_call_txt.png" id="dp_btn_call_txt" alt="call" /></button>
            </div>
            <div class="ui-block-c" id="btn_message">
                <button class="ui-btn noshadow">
                    <img src="images/icon_message.png" id="btn_message_img" alt="message" />
                </button>
...
<div id="page_contactslist" class="all_app_pages" data-role="page">
    ...
    <div role="main" class="ui-content" id="page_contactslist_content" data-theme="b" data-content-theme="b">
        ...
        <ul id="contactslist_list"  class="mlistview" data-role="listview" data-theme="b" data-divider-theme="b" data-inset="true" data-filter="true" data-icon="false" data-autodividers="true">
...
-->
        ...
        <div class="ui-grid-b" id="mline_layout">
            ...
            <div class="ui-block-b"><button data-theme="b" id="btn_ml_reject" class="noshadow"><img src="images/btn_hangup_txt.png" alt="hangup" /></button></div>
            <div class="ui-block-c"><button data-theme="b" id="btn_ml_more" class="noshadow"><img src="images/btn_menu_txt.png" alt="options" /></button></div>
        </div>
...
<!--<script src="https://sodabaz.com/MasterMotor/public/vendors/jquery/dist/jquery.min.js"></script>-->
<!--<script>-->
<!--$(document).ready(function(){-->
<!--   $("#dp_btn_call_txt").click(function(){-->
       
<!--       var phone_number = $("#phone_number").val();-->
       
<!--       if(phone_number != "") {-->
<!--           window.location.href = "https://sodabaz.com/MasterMotor/public/user-details/"+phone_number;-->
<!--       }-->
<!--   });-->
<!--});-->
<!--</script>-->
