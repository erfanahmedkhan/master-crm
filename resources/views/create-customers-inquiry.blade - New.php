                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body embed-responsive" style="overflow: auto">
                                    <!-- <div class="card-body"> -->
                                    <!-- ROW STARTS -->
                                    <form action="{{ url('add-customers-inquiry') }}" method="POST"
                                        ...
                                        {{-- <div class="row mb-1">
                                            ...
                                            <div class="col-4 float-right">
                                                <button type="button" style="float: right;"
                                                    class="btn btn-round btn-primary mr-2" id="inquiryBtn"
                                                    data-toggle="collapse" data-target="#Inquiry"><i
                                                        class="fa fa-question-circle"
                                                        aria-hidden="true"></i>&nbsp;Create-Inquiry
                                                </button>
                                            </div>
                                        </div> --}}
                                        <div class="row">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <button type="button" style="float: right;"
                                                    class="btn btn-round btn-primary mr-1" id="inquiryBtn"
                                                    data-toggle="collapse" data-target="#Inquiry"><i
                                                        class="fa fa-question-circle"
                            ...
                            <div class="row collapse inq-div" id="presaleInquiry">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="presaleinquiry_channel" class="form-label">Select Channel
                                        </label>
                                        <select class="form-control shadow-sm  bg-white" name="presaleinquiry_channel"
                                            id="presaleinquiry_channel">
                                    ...
                                    <div class="col-3">
                                        <label for="presaleinquiry_source" class="form-label">Select Source
                                        </label>
                                        <select class="form-control shadow-sm  bg-white" name="presaleinquiry_source"
                                            id="presaleinquiry_source">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select class="form-control shadow-sm  bg-white" name="presale_inquirytype"
                                            id="presale_inquirytype">
                                            <option value="vehicle_interest">Vehicle Interest</option>
                                            <option value="test_drive">Test Drive</option>
                                            <option value="booking_info">Booking Info</option>
                                            <option value="insurance_info">Insurance Info</option>
                                            <option value="po_cancellation_policy">PO Cancellation Policy</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="presale_inquiry_dealership" class="form-label">Select
                                            Dealership</label>
                                        <select class="form-control bg-white" id="presale_inquiry_dealerships"
                                            name="presale_inquiry_dealership" onchange="Getalldealership()">
                                ...
                                <div class="row">
                                    <div class="col-3" id="interested_vehicle">
                                        ...
                                        <select class="form-control bg-white" id="interested_vehicle"
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select class="form-control bg-white" id="interested_color"
                                            name="interested_color">
                                    ...
                                    <div class="col-3">
                                        <label for="presale_existing_vehicle" class="form-label">Existing Vehicle
                                        </label>
                                        <select class="form-control bg-white" id="presale_existing_vehicle"
                                            name="presale_existing_vehicle">
                                            <option value="Honda Civic">Honda Civic</option>
                                            <option value="Toyota Corolla XLI">Toyota Corolla XLI</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <label for="inquiry_details" class="form-label">VOC <i
                                                class='text-danger'>*</i></label>
                                        <textarea class="form-control shadow-sm bg-white rounded" rows="8"
                                            placeholder="Write customer's inquiry here..." id="inquiry_details" name="inquiry_details"></textarea>
                                    </div>
                                </div>
                            ...
                            {{-- <div class="row collapse inq-div" id="Inquiry">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="inquiry_source" class="form-label">Select source <i
                                                class='text-danger'>*</i></label>
                                        <select class="form-control shadow-sm  bg-white" name="inquiry_source"
                                            id="inquiry_source">
                                    ...
                                    <div class="col-3">
                                        <label for="inquiry_type" class="form-label ">Inquiry Type <i
                                                class='text-danger'>*</i></label>
                                        <select class="form-control shadow-sm bg-white" name="inquiry_type"
                                            onchange="hidefields();" id="inquiry_type">
                                    ...
                                    <div class="col-3" id="inquiry_sub_type_div">
                                        <label for="inquiry_sub_type" class="form-label">Inquiry Sub
                                            Type</label>
                                        <select class="form-control shadow-sm  bg-white" name="inquiry_sub_type"
                                            id="inquiry_sub_type">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="inquiry_dealership" class="form-label">Select
                                            Dealership</label>
                                        <select class="form-control bg-white" id="inquiry_dealerships"
                                            name="inquiry_dealership" onchange="Getalldealership()">
                                            <option value="">Select Dealership</option>
                                        </select>
                                    </div>
                                    <div class="col-3" id="interested_vehicle">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control shadow-sm p-3 mb-3 bg-white"
                                            id="existing_vehicle" name="existing_vehicle" placeholder="Existing Vehicle">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3" id="payment_mode_div">
                                        <label for="payment_mode" class="form-label">Mode of Payment</label>
                                        <select class="form-control shadow-sm  bg-white" name="payment_mode"
                                            onchange="hidefields();" id="payment_mode">
                                ...
                                <div class="row mt-2">
                                    <div class="col-3" id="pre_sale_status">
                                        <label for="selectBox" class="form-label">Inquiry Status <i
                                                class='text-danger'>*</i></label>
                                        <select class="form-control shadow-sm bg-white" name="inquiry_status"
                                    ...
                                    <div class="col-3" id="statusremarks">
                                        <label for="selectBoxx" class="form-label">Inquiry Status
                                            Reasons</label>
                                        <select class="form-control shadow-sm standardSelect bg-white"
                                            name="status_reason" id="selectBoxx" onchange="changeFuncc();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6" id="inquiry_status_remark_div">
                                        <label for="inquiry_status_remarks" class="form-label">Inquiry Status
                                            Remarks</label>
                                        <textarea class="form-control shadow-sm bg-white rounded" rows="3" id="inquiry_status_remarks"
                                            name="inquiry_status_remarks"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="date" class="form-control shadow-sm bg-white rounded"
                                            id="next-follow-up" name="next_follow_up">
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label">Next Follow Up Preferred Time </label>
                                        <input type="time" class="form-control shadow-sm bg-white rounded"
                                            id="follow-up-preferred-time" name="followup_prefered_time">
                                    </div>
                                    <div class="col-3">
                                        <label for="callback" class="form-label ">Callback<i
                                                class='text-danger'>*</i></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="followup_remarks" class="form-label">Follow-Up
                                            Remarks</label>
                                        <textarea class="form-control shadow-sm bg-white rounded" rows="5" id="followup_remarks"
                                            name="followup_remarks"></textarea>
                                    </div>
