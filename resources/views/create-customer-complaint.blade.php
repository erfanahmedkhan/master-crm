                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <strong class="card-title">&nbsp;Create Customer Complaint</strong>
                                </div>
                                <!-- card-body STARTS -->
                                <div class="card-body embed-responsive" style="overflow: auto">
                                    <!-- <div class="card-body"> -->
                                    <!-- ROW STARTS -->
                                    <form action="{{ url('add-customer-inquiry') }}" method="POST"
                                        ...
                                        <div class="row collapse" id="genComplain">
                                            <div class="row">
                                        ...
                                        <div class="row collapse" id="presaleComplain">
                                            <div class="row">
                                                <div class="col-md-12 mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control shadow-sm bg-white rounded" id="presale_agent_complain_notes"
                                                        name="presale_agent_complain_notes" placeholder="Take notes if necessary..." rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                        ...
                                        <div class="row collapse" id="saleComplain">
                                            <div class="col-md-12 mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <label for="sale_customer_vehicle" class="form-label">Vehicle<i
                                                            class='text-danger'>*</i></label>
                                                    <input type="text" name="sale_customer_vehicle"
                                                        id="sale_customer_vehicle"
                                                        class="form-control shadow-sm p-3 mb-3 bg-white dmsfield customer_vehicle"
                                                        placeholder="Alsvin">
                                                </div>
                                        ...
                                        <div class="row collapse" id="aftersaleComplain">
                                            <div class="col-md-12 mb-4">
                                                <h5><i class="fa fa-comments" aria-hidden="true"></i> Complaint Details
                                                </h5>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm p-3 mb-3 bg-white"
                                                        name="aftersale_chasis_number" placeholder="Chasis Number">
                                                </div>
                                                <div class="col-3">
                                                    <label class="form-label">Engine Number</label>
                                                    <input type="text" class="form-control shadow-sm p-3 mb-3 bg-white"
                                                        name="aftersale_engine_number" placeholder="Engine Number">
                                                </div>
                                                <div class="col-3">
                                                    <label class="form-label">PBO</label>
                                                    <input type="text" class="form-control shadow-sm p-3 mb-3 bg-white"
                                                        id="" name="aftersale_pbo" placeholder="PBO">
                                                </div>
                                                <div class="col-3 ">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <select class="form-control shadow-sm bg-white customer_vehicle"
                                                        id="aftersale_vehicle_colour" name="aftersale_vehicle_colour">
                                                ...
                                                <div class="col-3 ">
                                                    ...
                                                    <input type="date" class="form-control shadow-sm p-3 mb-3 bg-white"
                                                        name="aftersale_invoice_date" placeholder="Invoice Date">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
